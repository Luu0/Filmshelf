...
export default function MovieView() {
  const [_match, params] = useRoute("/movie/:id");
  ...
  }, [id, fetchMovieById, clearSelectedMovie]);
    ...
    <div className="w-full min-h-screen bg-linear-to-br from-[#1d1c1b] to-[#3a3636] text-white p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* Columna Izquierda (Imagen, Rating, Review) */}
          ...
          {/* Columna Derecha (Descripción, Buzz) */}
          <div className="lg:w-2/3 space-y-6">
            <div>
              ...
              <p className="mt-4 text-base font-bold">
                Duración: 
                <span className="font-normal text-gray-200 ml-2">{data.runtime} min</span>
              </p>
            </div>
