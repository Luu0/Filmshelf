      ...
      <div className="relative bg-black/5 backdrop-blur-xl rounded-3xl px-[44px] py-[62px] max-w-lg w-full shadow-[0px_0px_50px_5px_rgba(128,0,255,0.1)] z-10">
        ...
        <div className="flex flex-col gap-7">
          ...
          <Input label="Email" name="email" type="email"
            form={form} onChange={handleChange} placeholder="carlos@gmail.com"
            error={errors.email} />

          <Input label="Username" name="username" type="text"
            form={form} onChange={handleChange} placeholder="carlos"
            error={errors.username} />

          <Input label="Password" name="password" type="password"
            form={form} onChange={handleChange} placeholder="example123"
