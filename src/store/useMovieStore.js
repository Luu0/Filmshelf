  ...
  fetchTrending: async () => {
    ...
    try {
      ...
      if (moviesWithBackdrop.length > 0) {
        ...
        movieToDisplay = moviesWithBackdrop[Math.floor(Math.random() * moviesWithBackdrop.length)];
      ...
      if (movieToDisplay) {
        ...
        set({
          ...
          titleMovie: movieToDisplay.title || movieToDisplay.name || "Película sin título",
        });
      } else {
